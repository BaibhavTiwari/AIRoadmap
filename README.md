# Lean AI Roadmap — Full Detail Edition (Topics, Free Resources, Guidance)
...
### What to build
A **RAG chatbot over real documents**, ideally tied to your own story:
- Use old ClickPost/RestoLabs support documentation, public API docs of a product you know, or your own notes
...
### Detailed guidance
- **Rewrite bullet points**, don't just add keywords:
  - "Resolved 200+ support tickets/month" → "Performed root-cause analysis on production issues across [product], reducing repeat escalations by X%"
  - "Explained technical concepts to customers" → "Bridged technical and non-technical stakeholders, translating system behavior into actionable guidance"
...
- **Levels.fyi (free)** — https://www.levels.fyi/ — benchmark comp for these roles, India-specific filters available
